...
public:
	...
	~SingleLinkedList();
	const SingleLinkedList<T> operator=(const SingleLinkedList<T>& right);
	const SingleLinkedList<T> operator=(SingleLinkedList<T>&& right);
...
template<class T>
inline const T & SingleLinkedList<T>::getElement(int pos) const
{
	T tmp = head;
...
template<class T>
inline const SingleLinkedList<T> SingleLinkedList<T>::operator=(const SingleLinkedList<T>& right)
{
	if (this == &right)
	{
		return *this<T>;
...
template<class T>
inline const SingleLinkedList<T> SingleLinkedList<T>::operator=(SingleLinkedList<T>&& right)
{
...
template<class T>
inline SingleLinkedList<T>::SingleLinkedList(const SingleLinkedList & obj)
{
